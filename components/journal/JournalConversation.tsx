...
export const JournalConversation: React.FC<JournalConversationProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[60] flex flex-col">
      ...
      {/* Sheet */}
      <div
        className={`relative w-full sm:max-w-md bg-card sm:rounded-t-2xl shadow-2xl flex flex-col transition-transform duration-[var(--duration-normal)] ease-out ${
            ...
            <div className="p-4 border-t border-border shrink-0 space-y-2">
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="p-2.5 bg-gold hover:bg-gold-muted text-foreground rounded-xl transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  <Send size={16} />
                </button>
              </div>
