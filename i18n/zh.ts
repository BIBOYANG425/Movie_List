...
const zh = {
  ...
  'ceremony.showingResultsFor': '显示以下结果',
  ...
  'onboarding.pickMovies': '{n} 部电影',
  'onboarding.pickSuffix': '你看过的电影来生成你的排名。之后你随时可以调整和微调。',
  ...
  'onboarding.born': '出生',
  'onboarding.filmSingular': '部作品',
  'onboarding.filmPlural': '部作品',
  'onboarding.directed': '执导',
  'onboarding.starredIn': '出演',
