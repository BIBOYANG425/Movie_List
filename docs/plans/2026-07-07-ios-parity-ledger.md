...
| C5 | TV seasons + books | web fixes in PR on `fix/c5-tv-books-web-blocking` (HEAD 61346c1); iOS C5 plan next on the corrected base | audits/2026-07-10-c5-tv-books-web-audit.md | `fix/c5-tv-books-web-blocking` | — |
